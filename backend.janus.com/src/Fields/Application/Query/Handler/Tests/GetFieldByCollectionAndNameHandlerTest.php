...
abstract class GetFieldByCollectionAndNameHandlerTest extends TestCase
{
    /** @var MockObject&FieldMetaRepositoryInterface */
    protected MockObject $repository;
    protected GetFieldByCollectionAndNameHandler $handler;

    public function setUp(): void
    {
        $this->repository = $this->createMock(FieldMetaRepositoryInterface::class);
        $this->handler    = new GetFieldByCollectionAndNameHandler(repository: $this->repository);
    }
