...
/**
 * @file GetDashboardByIdHandlerTest.php
 *
 * Abstract base for GetDashboardByIdHandler test suites.
 *
...
/**
 * Common setup, teardown, and factory helpers for GetDashboardByIdHandler test suites.
 */
#[CoversClass(className: GetDashboardByIdHandler::class)]
abstract class GetDashboardByIdHandlerTest extends TestCase
{
    /**
     ...
     */
    protected GetDashboardByIdHandler $class;
    ...
    public function setUp(): void
    {
        ...
        $this->class      = new GetDashboardByIdHandler(repository: $this->repository);
    }
