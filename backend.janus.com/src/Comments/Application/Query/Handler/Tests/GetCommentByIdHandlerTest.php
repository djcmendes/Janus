...
/**
 * @file GetCommentByIdHandlerTest.php
 *
 * Abstract base for all GetCommentByIdHandler test suites.
 *
...
/**
 * Abstract base for GetCommentByIdHandler tests.
 *
...
abstract class GetCommentByIdHandlerTest extends TestCase
{
     ...
     */
    protected GetCommentByIdHandler $class;

    /**
     * Reflection of GetCommentByIdHandler.
     * @var ReflectionClass<GetCommentByIdHandler>
     */
    ...
    protected function setUp(): void
    {
        ...
        $this->class      = new GetCommentByIdHandler(repository: $this->repository);
        $this->reflection = new ReflectionClass(GetCommentByIdHandler::class);
    }
