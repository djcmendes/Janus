...
abstract class GetActivityHandlerTest extends TestCase
{
    ...
    /**
     * Reflection of GetActivityHandler class.
    ...
    public function setUp(): void
    {
        ...
        $this->class      = new GetActivityHandler(repository: $this->repository);
        $this->reflection = new ReflectionClass(objectOrClass: GetActivityHandler::class);
    }
